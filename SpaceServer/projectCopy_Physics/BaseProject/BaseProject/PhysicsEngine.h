...
private:
	CollisionInfo DC(PhysicsObject2D* _object1, PhysicsObject2D* _object2);
	void GetMinAndMax(PhysicsObject2D* _object, Vector2D &_min, Vector2D &_max, float &_minDot, float &_maxDot, Vector2D _axis);
	void GetMinAndMaxBounds(PhysicsObject2D* _object, Vector2D &_min, Vector2D &_max, float &_minDot, float &_maxDot, Vector2D _axis);
};
